...
export async function getUsers() {
  ...
  return users.map((u) => {
    const activePlan = u.event && u.event.active ? u.event.plan : null;
    ...
    return {
      ...
      plan: activePlan || chosenPlan, // "BASICO" | "PRO" | "VIP" | null
      pending: !activePlan && !!chosenPlan, // chose a plan but panel not enabled yet
      hasEvent: !!u.event,
